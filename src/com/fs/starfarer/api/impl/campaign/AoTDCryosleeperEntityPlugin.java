...
public class AoTDCryosleeperEntityPlugin extends BaseCustomEntityPlugin{
    ...
    Object readResolve() {
        if (engineGlow == null) {
            Color fringe = new Color(161, 0, 255, 255);
            ...
            CampaignEngineGlowIndividualEngine engine = new CampaignEngineGlowIndividualEngine(
                    90f, 70f, 20F, 100f, new Vector2f(-50, 0f), engineGlow);
